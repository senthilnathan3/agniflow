import { defaultConfig } from "@agniflow-ui/react"
...
export const EjectCommand = new Command("eject")
  ...
  .action(async (flags: CodegenFlags) => {
    ...
    import { defineGlobalStyles } from "@agniflow-ui/react"
    ...
    import { defineTextStyles } from "@agniflow-ui/react"
    ...
    import { defineLayerStyles } from "@agniflow-ui/react"
    ...
    import { defineAnimationStyles } from "@agniflow-ui/react"
    ...
    artifacts.push({
      ...
      content: `
import { createSystem, defaultBaseConfig, defineConfig, mergeConfigs } from "@agniflow-ui/react"
...
function generateSlotRecipeArtifacts(
  ...
  for (const [name, recipe] of Object.entries(slotRecipes)) {
    const content = `
    import { defineSlotRecipe } from "@agniflow-ui/react"
...
function generateSemanticTokenArtifacts(
  ...
  for (const [name, token] of Object.entries(semanticTokens)) {
    const content = `
    import { defineSemanticTokens } from "@agniflow-ui/react"
...
function generateTokenArtifacts(
  ...
  for (const [name, token] of Object.entries(tokens)) {
    const content = `
    import { defineTokens } from "@agniflow-ui/react"
